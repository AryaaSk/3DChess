    ...
    enableMovementControls(canvasID: string, rotation?: boolean, movement?: boolean, zoom?: boolean, limitRotation?: boolean)
    {
        ...
        document.getElementById(canvasID)!.onpointermove = ($e) => {
            ...
            if (altDown == true && movement == true) {
                ...
                if (this.worldRotation.x < -90 && limitRotation == true) { this.worldRotation.x = -90; } else if (this.worldRotation.x > 0 && limitRotation == true) { this.worldRotation.x = 0; } //added this line for chess game, since I render pieces on top of board
                this.updateRotationMatrix();
            }
